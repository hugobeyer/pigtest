...
TRAIL_NAMES=('Trail_Light','Trail_Dark')
...
REQUIRED_NAMES=(*PIG_COLUMN_NAMES,*PIG_NAMES,*BULLET_NAMES,*TRAIL_NAMES,*RAIL_NAMES,*BLOCK_NAMES,*SLOT_NAMES,*ANCHOR_NAMES)
RENDERABLE_NAMES=(*PIG_NAMES,*BULLET_NAMES,*TRAIL_NAMES,*RAIL_NAMES,*BLOCK_NAMES,*SLOT_NAMES)
